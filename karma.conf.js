...
module.exports = function (config) {
    config.set({
        ...
        //     'src/transformer/map.ts',
        //     'src/transformer/map.spec.ts',
        //     'src/transformer/flat.ts',
        //     'src/transformer/one.ts',
        //     'src/transformer/take.ts',
        //     'src/transformer/default.ts',
        //     'src/transformer/default.spec.ts',
        //     'src/transformer/optional.spec.ts',
        //     'src/transformer/optional.spec.ts',
