 ...
 */
export const defer = <T, U, V extends any[]>(dataGeneratorFn: (...args: V) => DataGenerator<T>, deferredProject: (arg: DataGenerator<T>) => DataGenerator<U>): (...args: V) => DataGenerator<U> => (...args: V) => deferredProject(dataGeneratorFn(...args));